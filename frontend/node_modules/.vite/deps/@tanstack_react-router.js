import {
  require_react_dom
} from "./chunk-U54NM2KE.js";
import {
  require_jsx_runtime
} from "./chunk-JCNATDVP.js";
import {
  __commonJS,
  __toESM,
  require_react
} from "./chunk-XRA2PTYI.js";
    ...
    while (cursor < length) {
      ...
      switch (segment[0]) {
        ...
        case 1: {
          ...
          const existingNode = !skipOnParamError && ((_h = node.dynamic) == null ? void 0 : _h.find((s) => !s.skipOnParamError && s.caseSensitive === actuallyCaseSensitive && s.prefix === prefix2 && s.suffix === suffix));
          if (existingNode) nextNode = existingNode;
          else {
            const next = createDynamicNode(1, route.fullPath ?? route.from, actuallyCaseSensitive, prefix2, suffix);
            nextNode = next;
            next.depth = depth;
            next.parent = node;
        ...
        case 3: {
          ...
          const prefix2 = !prefix_raw ? void 0 : actuallyCaseSensitive ? prefix_raw : prefix_raw.toLowerCase();
          const suffix = !suffix_raw ? void 0 : actuallyCaseSensitive ? suffix_raw : suffix_raw.toLowerCase();
          const existingNode = !skipOnParamError && ((_i = node.optional) == null ? void 0 : _i.find((s) => !s.skipOnParamError && s.caseSensitive === actuallyCaseSensitive && s.prefix === prefix2 && s.suffix === suffix));
          if (existingNode) nextNode = existingNode;
          else {
            const next = createDynamicNode(3, route.fullPath ?? route.from, actuallyCaseSensitive, prefix2, suffix);
            nextNode = next;
            next.parent = node;
            next.depth = depth;
        ...
        case 2: {
          ...
          const prefix2 = !prefix_raw ? void 0 : actuallyCaseSensitive ? prefix_raw : prefix_raw.toLowerCase();
          const suffix = !suffix_raw ? void 0 : actuallyCaseSensitive ? suffix_raw : suffix_raw.toLowerCase();
          const next = createDynamicNode(2, route.fullPath ?? route.from, actuallyCaseSensitive, prefix2, suffix);
          nextNode = next;
          next.parent = node;
          next.depth = depth;
  ...
  */
  constructor(options) {
    ...
    this.matchRoute = (location, opts) => {
      ...
      const baseLocation = ((opts == null ? void 0 : opts.pending) === void 0 ? !this.state.isLoading : opts.pending) ? this.latestLocation : this.state.resolvedLocation || this.state.location;
...
function useRouterState(opts) {
  ...
  const previousResult = (0, import_react3.useRef)(void 0);
...
function useLinkProps(options, forwardedRef) {
  ...
  const _options = React$19.useMemo(() => {
    return {
      ...options,
      from
    };
  ...
  const next = React$19.useMemo(() => router.buildLocation({ ..._options }), [router, _options]);
  ...
  const isActive = useRouterState({ select: (s) => {
    ...
    if (activeOptions == null ? void 0 : activeOptions.includeHash) return isHydrated && s.location.hash === next.hash;
    return true;
  } });
...
var FileRoute = class {
  constructor(path, _opts) {
    ...
    this.createRoute = (options) => {
      if (true) tiny_warning_esm_default(this.silent, "FileRoute is deprecated and will be removed in the next major version. Use the createFileRoute(path)(options) function instead.");
...
function FileRouteLoader(_path) {
  if (true) tiny_warning_esm_default(false, `FileRouteLoader is deprecated and will be removed in the next major version. Please place the loader function in the the main route file, inside the \`createFileRoute('/path/to/file')(options)\` options`);
...
var MatchInner = React$111.memo(function MatchInnerImpl({ matchId }) {
  ...
  const { match, key, routeId } = useRouterState({
    select: (s) => {
      ...
      const remountDeps = (_a2 = router.routesById[routeId2].options.remountDeps ?? router.options.defaultRemountDeps) == null ? void 0 : _a2({
        routeId: routeId2,
  ...
  if (match._displayPending) throw (_a = router.getMatch(match.id)) == null ? void 0 : _a._nonReactive.displayPendingPromise;
  if (match._forcePending) throw (_b = router.getMatch(match.id)) == null ? void 0 : _b._nonReactive.minPendingPromise;
...
function useMatchRoute() {
  ...
  useRouterState({
    select: (s) => {
      ...
      return [
        s.location.href,
        (_a = s.resolvedLocation) == null ? void 0 : _a.href,
        s.status
      ];
    },
    structuralSharing: true
...
function useLocation(opts) {
  return useRouterState({ select: (state) => (opts == null ? void 0 : opts.select) ? opts.select(state.location) : state.location });
}
...
var Scripts = () => {
  ...
  return (0, import_jsx_runtime15.jsx)(import_jsx_runtime15.Fragment, { children: allScripts.map((asset, i) => (0, import_react9.createElement)(Asset, {
    ...asset,
...
function HeadContent2() {
  ...
  }) : tags).map((tag) => (0, import_react11.createElement)(Asset, {
    ...tag,
