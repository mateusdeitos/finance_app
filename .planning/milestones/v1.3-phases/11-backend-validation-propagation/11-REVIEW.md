...
Or, extend `validateUpdateTransactionRequest` to require `DestinationAccountID` whenever the _existing_ transaction type is transfer and the caller does not provide a new type:
