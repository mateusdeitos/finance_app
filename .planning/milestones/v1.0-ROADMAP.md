...
**Plans**: 2 plans
Plans:
- [x] 04-01-PLAN.md — Backend integration tests (TST-01/02/03) and validation unit tests (TST-04/05/06)
- [x] 04-02-PLAN.md — E2E seed fix (E2E-01) and new recurrence Playwright tests (E2E-02/03/04)
