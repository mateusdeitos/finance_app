...
The keys live in `.claude/settings.json` (project) or `/Users/Mateus.Campos/Documents/github/finance_app/.claude/settings.json` (global) — **not** in `.planning/config.json`:
