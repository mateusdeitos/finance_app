...
```bash
INIT=$(node "/Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
