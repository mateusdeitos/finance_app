...
- **Global scope**: `/Users/Mateus.Campos/Documents/github/finance_app/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/Mateus.Campos/Documents/github/finance_app/.claude/notes/`)
...
2. Glob `/Users/Mateus.Campos/Documents/github/finance_app/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/Mateus.Campos/Documents/github/finance_app/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/Mateus.Campos/Documents/github/finance_app/.claude/notes/` — works in any directory
