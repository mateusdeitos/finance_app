...
```bash
INIT=$(node "/Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/templates/spec.md.
