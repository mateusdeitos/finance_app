...
```
Task(
  prompt="Read /Users/Mateus.Campos/Documents/github/finance_app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/templates/VALIDATION.md`
