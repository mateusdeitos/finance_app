...
INSTALL_JS_GLOBAL="/Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
