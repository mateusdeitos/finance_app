...
<required_reading>
Read `/Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
