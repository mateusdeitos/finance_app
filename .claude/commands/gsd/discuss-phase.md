...
Read and execute `/Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/workflows/discuss-phase-assumptions.md` end-to-end.

If `DISCUSS_MODE` is `"discuss"` (or unset, or any other value):
Read and execute `/Users/Mateus.Campos/Documents/github/finance_app/.claude/get-shit-done/workflows/discuss-phase.md` end-to-end.
