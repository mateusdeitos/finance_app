...
type UserConnection struct {
	...
	FromUserAvatarURL          *string                  `json:"from_user_avatar_url,omitempty"`
...
type UserConnectionSearchOptions struct {
	...
	// ParticipantUserID restricts results to connections in which this user is
	// one of the two participants. Public request paths must always set it.
	ParticipantUserID int                      `json:"-"`
	ConnectionStatus  UserConnectionStatusEnum `json:"connection_status"`
