...
// NullifyCategory provides a mock function with given fields: ctx, categoryID
func (_m *MockTransactionRepository) NullifyCategory(ctx context.Context, categoryID int) error {
	ret := _m.Called(ctx, categoryID)

	if len(ret) == 0 {
		panic("no return value specified for NullifyCategory")
	}
...
// MockTransactionRepository_NullifyCategory_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'NullifyCategory'
type MockTransactionRepository_NullifyCategory_Call struct {
	*mock.Call
}

// NullifyCategory is a helper method to define mock.On call
//   - ctx context.Context
//   - categoryID int
func (_e *MockTransactionRepository_Expecter) NullifyCategory(ctx interface{}, categoryID interface{}) *MockTransactionRepository_NullifyCategory_Call {
	return &MockTransactionRepository_NullifyCategory_Call{Call: _e.mock.On("NullifyCategory", ctx, categoryID)}
}

func (_c *MockTransactionRepository_NullifyCategory_Call) Run(run func(ctx context.Context, categoryID int)) *MockTransactionRepository_NullifyCategory_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int))
	})
	return _c
...
func (_c *MockTransactionRepository_NullifyCategory_Call) Return(_a0 error) *MockTransactionRepository_NullifyCategory_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTransactionRepository_NullifyCategory_Call) RunAndReturn(run func(context.Context, int) error) *MockTransactionRepository_NullifyCategory_Call {
	_c.Call.Return(run)
	return _c
}
...
// MockTransactionRepository_ReassignCategory_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ReassignCategory'
type MockTransactionRepository_ReassignCategory_Call struct {
	*mock.Call
}
...
//   - fromID int
//   - toID int
func (_e *MockTransactionRepository_Expecter) ReassignCategory(ctx interface{}, fromID interface{}, toID interface{}) *MockTransactionRepository_ReassignCategory_Call {
	return &MockTransactionRepository_ReassignCategory_Call{Call: _e.mock.On("ReassignCategory", ctx, fromID, toID)}
}

func (_c *MockTransactionRepository_ReassignCategory_Call) Run(run func(ctx context.Context, fromID int, toID int)) *MockTransactionRepository_ReassignCategory_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int), args[2].(int))
	})
	return _c
...
func (_c *MockTransactionRepository_ReassignCategory_Call) Return(_a0 error) *MockTransactionRepository_ReassignCategory_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTransactionRepository_ReassignCategory_Call) RunAndReturn(run func(context.Context, int, int) error) *MockTransactionRepository_ReassignCategory_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockTransactionRepository) UpdateReviewedByIDs(ctx context.Context, userID int, ids []int, reviewed bool) error {
...
// MockTransactionRepository_UpdateReviewedByIDs_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateReviewedByIDs'
type MockTransactionRepository_UpdateReviewedByIDs_Call struct {
	*mock.Call
}
...
//   - ids []int
//   - reviewed bool
func (_e *MockTransactionRepository_Expecter) UpdateReviewedByIDs(ctx interface{}, userID interface{}, ids interface{}, reviewed interface{}) *MockTransactionRepository_UpdateReviewedByIDs_Call {
	return &MockTransactionRepository_UpdateReviewedByIDs_Call{Call: _e.mock.On("UpdateReviewedByIDs", ctx, userID, ids, reviewed)}
}

func (_c *MockTransactionRepository_UpdateReviewedByIDs_Call) Run(run func(ctx context.Context, userID int, ids []int, reviewed bool)) *MockTransactionRepository_UpdateReviewedByIDs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockTransactionRepository_UpdateReviewedByIDs_Call) Return(_a0 error) *MockTransactionRepository_UpdateReviewedByIDs_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockTransactionRepository_UpdateReviewedByIDs_Call) RunAndReturn(run func(context.Context, int, []int, bool) error) *MockTransactionRepository_UpdateReviewedByIDs_Call {
	_c.Call.Return(run)
	return _c
}
